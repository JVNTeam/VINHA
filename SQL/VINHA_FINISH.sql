...
CREATE TABLE ma_giam_gia (
    ...
    /*
        ...
        Ví dụ: Giảm 20%, Tối đa 50.000đ
    */
                             giam_toi_da DECIMAL(12,2) CHECK(giam_toi_da >= 0),
    -- Đơn hàng tối thiểu để áp dụng voucher
                             don_toi_thieu DECIMAL(12,2) DEFAULT 0 CHECK(don_toi_thieu >= 0),
    ...
    /*
        ...
        Ví dụ: SO_DON, CHI_TIEU, VIP, BLACK_FRIDAY, TET_2027...
    */
                             loai_dieu_kien NVARCHAR(50),
    /*
        Giá trị điều kiện.
        SO_DON -> 20, CHI_TIEU -> 5000000
...
CREATE TABLE don_hang (
                          ...
                          hinh_thuc_thanh_toan NVARCHAR(30) CHECK(hinh_thuc_thanh_toan IN(N'Tiền mặt', N'Chuyển khoản', N'Ví điện tử')),
                          trang_thai NVARCHAR(30) DEFAULT N'Chờ xác nhận' CHECK(trang_thai IN(N'Chờ xác nhận', N'Xác nhận', N'Hoàn thành', N'Hủy')),
                          ngay_tao DATETIME2 DEFAULT GETDATE(),
...
-- 2. NGƯỜI DÙNG
INSERT INTO nguoi_dung (vai_tro_id, ho_ten, email, so_dien_thoai, cccd, mat_khau, gioi_tinh, ngay_sinh, anh_dai_dien)
VALUES
...
INSERT INTO nguoi_dung (vai_tro_id, ho_ten, email, so_dien_thoai, cccd, mat_khau, gioi_tinh, ngay_sinh, anh_dai_dien, trang_thai)
VALUES (3, N'Quản trị viên', 'admin@vinha.com', '0988888887', '001234567890', '123456', 0, '2000-01-01', NULL, N'Hoạt Động');

-- 3. ĐỊA CHỈ
INSERT INTO dia_chi (nguoi_dung_id, ten_nguoi_nhan, sdt_nguoi_nhan, dia_chi, mac_dinh)
VALUES
...
-- 8. CHI TIẾT GIỎ HÀNG
INSERT INTO chi_tiet_gio_hang (gio_hang_id, mon_an_id, so_luong, don_gia)
VALUES
    (1, 1, 2, 45000),
    (2, 2, 1, 65000);

-- 9. MÃ GIẢM GIÁ
INSERT INTO ma_giam_gia (ma, mo_ta, loai_giam, gia_tri_giam, giam_toi_da, don_toi_thieu, so_luong, gioi_han_nhan, loai_dieu_kien, gia_tri_dieu_kien, ngay_bat_dau, ngay_ket_thuc)
VALUES
...
INSERT INTO nguoi_dung_ma_giam_gia (nguoi_dung_id, ma_giam_gia_id)
VALUES
    (1, 1),
    (2, 2);

-- 11. ĐƠN HÀNG
INSERT INTO don_hang (nguoi_dung_id, dia_chi_id, ma_giam_gia_id, nhan_vien_id, ghi_chu, tam_tinh, phi_giao_hang, tien_giam, tong_tien, thoi_gian_du_kien, hinh_thuc_thanh_toan, trang_thai)
VALUES
...
INSERT INTO chi_tiet_don_hang (don_hang_id, mon_an_id, so_luong, don_gia)
VALUES
    (1, 1, 2, 45000),
    (2, 2, 1, 65000);

-- 13. THANH TOÁN
INSERT INTO thanh_toan (don_hang_id, ma_giao_dich, so_tien, phuong_thuc, trang_thai, thoi_gian)
VALUES
...
INSERT INTO lich_su_trang_thai (don_hang_id, nhan_vien_id, trang_thai)
VALUES
    (1, 2, N'Chờ xác nhận'),
    (2, 2, N'Xác nhận');

-- 15. ĐÁNH GIÁ
INSERT INTO danh_gia (don_hang_id, mon_an_id, nguoi_dung_id, so_sao, binh_luan)
VALUES
