...
public class HinhAnhController {
    ...
    public String showImageManagementPage(
        ...
        List<String> categories = List.of("Tất cả món ăn", "Cơm gà", "Cơm sườn", "Cơm cá", "Cơm bò", "Cơm niêu");
    ...
    private Map<String, Object> createImageItem(String stt, String dishName, String imageUrl, String path, String status) {
