...
public class MonAnController {
        ...
        public String showProductManagementPage(
                ...
                products.add(createProduct("01", "Cơm Sườn Nướng", "Cơm Sườn", "45.000đ", 120, 1254, "ACTIVE",
                                "Đang bán",
                                "https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=150&auto=format&fit=crop"));

                products.add(createProduct("02", "Cơm Gà Xối Mỡ", "Cơm Gà", "55.000đ", 0, 842, "OUT_OF_STOCK",
                                "Hết hàng",
        ...
        private Map<String, Object> createProduct(String stt, String name, String category, String price, int stock,
                        int sold, String statusCode, String statusText, String image) {
